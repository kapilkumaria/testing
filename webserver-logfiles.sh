...
echo "<html><h1>This is log number 1</h1></html>" > /var/www/html/logfiles/log1
echo "<html><h1>This is log number 2</h1></html>" > /var/www/html/logfiles/log2
echo "<html><h1>This is log number 3</h1></html>" > /var/www/html/logfiles/log3
